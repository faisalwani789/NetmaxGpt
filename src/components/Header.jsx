...
const Header = () => {
  ...
  return (
    <div className="flex justify-between absolute w-full z-10 ">
      ...
      {user && <div>
         <img  className="self-center mr-39 w-25" src={user.photoURL ||"https://occ-0-6247-2164.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABdpkabKqQAxyWzo6QW_ZnPz1IZLqlmNfK-t4L1VIeV1DY00JhLo_LMVFp936keDxj-V5UELAVJrU--iUUY2MaDxQSSO-0qw.png?r=e6e"} alt="userLogo" />
         <ul >
